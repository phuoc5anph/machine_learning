...
class LeNet(object):
    ...
    def forward_prop(self, input_data):
        ...
        self.z5 = self.fully_connect(self.l4, self.fc1)      # (batch_sz, 200)
        self.l5 = self.relu(self.z5)                         # (batch_sz, 200)
        self.z6 = self.fully_connect(self.l5, self.fc2)      # (batch_sz, 10)
        self.l6 = self.relu(self.z6)                         # (batch_sz, 10)
        self.l7 = self.softmax(self.l6)                      # (batch_sz, 10)
