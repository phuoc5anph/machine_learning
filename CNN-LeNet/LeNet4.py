...
class LeNet(object):
    ...
    def backward_prop(self, softmax_output, output_label):
        ...
        #N>0; fc2_deriv = N*2(y-y^)*derivRelu(z)*l6; z=Wx+bias=l7; l6=input_fc2
        ...
        #N>0; fc1_deriv = N*2(y-y^)*derivRelu(z)*l4; z=Wx+bias=l5; l4=input_fc1
...
if __name__ == '__main__':
    ...
    lr = 0.01;     max_iter = 937*5; iter_mod = int(data_size/batch_sz)
    print(iter_mod)
